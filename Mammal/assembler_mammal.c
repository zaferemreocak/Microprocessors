...
//========================================   FIRST PASS   ======================================================
            while (token)
            {
                ...
                else if (strcmp(token,"ld")==0)      //------------LD INSTRUCTION---------------------      0000000000 000000   003f
                {
                    ...
                    //program[counter]=0x2000+((ch)&0x01ff);       //form the instruction and write it to memory
                    counter++;                                   //skip to the next empty location in memory
                }
                else if (strcmp(token,"st")==0) //-------------ST INSTRUCTION-------------------- 0000 000 0 0000 0000  01f8
                {
                    op1 = strtok(NULL,"\n\t\r ");                //get the 1st operand of st, which is the register that contains the address to be written inside
                    op2 = strtok(NULL,"\n\t\r ");                //get the 2nd operand of st, which is the register that contains the data to be transferred to memory
                ...
                else if (strcmp(token,"sub")==0)
                {
                    ...
                    op3 = strtok(NULL,"\n\t\r ");
                    chch = (op1[0]-48)| ((op2[0]-48)<<3)|((op3[0]-48)<<6);  
                    program[counter]=0x7200+((chch)&0x0fff);
                    counter++; 
                }
                else if (strcmp(token,"and")==0)
                {
                    ...
                    op3 = strtok(NULL,"\n\t\r ");
                    chch = (op1[0]-48)| ((op2[0]-48)<<3)|((op3[0]-48)<<6);  
                    program[counter]=0x7400+((chch)&0x0fff); 
                    counter++; 
                }
                else if (strcmp(token,"or")==0)
                {
                    ...
                    op3 = strtok(NULL,"\n\t\r ");
                    chch = (op1[0]-48)| ((op2[0]-48)<<3)|((op3[0]-48)<<6);  
                    program[counter]=0x7600+((chch)&0x0fff); 
                    counter++; 
                }
                else if (strcmp(token,"xor")==0)
                {
                    ...
                    op3 = strtok(NULL,"\n\t\r ");
                    chch = (op1[0]-48)| ((op2[0]-48)<<3)|((op3[0]-48)<<6);  
                    program[counter]=0x7800+((chch)&0x0fff); 
                    counter++; 
                }
                ...
                {
                    op1 = strtok(NULL,"\n\t\r ");
                    unsigned ch = ((op1[0]-48)<<6);
                    program[counter]=0x8000+((ch)&0x01c0);
                    counter++;
                }
                else if (strcmp(token,"pop")==0)
                {
                    op1 = strtok(NULL,"\n\t\r ");
                    //printf("Operant: %s\n",op1);
                    unsigned ch = ((op1[0]-48));
                    //printf("CharValue: %04x\n",ch);
                ...
                {
                    program[counter]=0xf000;
                    counter++;
                }
                else if (strcmp(token,"iret")==0)
                {
                    program[counter]=0x6000;
                    counter++;
                }
...
//supply the address fields of the jump and jz instructions by matching jumptable and labeltable
        ...
        {
            j=0;
            while ( strcmp(jumptable[i].name , labeltable[j].name ) != 0 )  //if the label for this jump/jz does not match with the 
...
//display the resulting tables
        ...
        printf("\n");
        fclose(fp);
        //========== to switch between Logisim and Verilog RAM file ==========
        fp = fopen("RAM.txt","w");
        fprintf(fp,"v2.0 raw\n");
        //========== to switch between Logisim and Verilog RAM file format ==========
        /*
